...
import { protectorMiddleware, videoUpload } from "../middleware/localsMiddleware.js";
...
router.route("/upload").all(protectorMiddleware).get(videoController.getUpload).post(videoUpload.single("video"), videoController.postUpload);
